...
public  class SendMail {
    public static void send(String emily, HttpServletRequest req, HttpServletResponse resp){
        ...
        try {
            ...
            email.setMsg("<a href=http://localhost:63342/DormSystem/emily.html?>重置密码</a>");
            // 发送
            email.send();
