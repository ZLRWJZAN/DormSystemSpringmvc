    ...
    layui.config({
        ...
        bodyTab.set({
            ...
            ajaxSettings: {  //ajax参数，与jquery.ajax一致
                url: "services/data/menu.json?language=ch",
                type: 'get'
            }
        });
        ...
        skins();
        //设置中文语言
        $(".closechlanguage").click(function(){
            bodyTab.set({
                openTabNum: "50",  //最大可打开窗口数量
                tabFilter: "bodyTab",  //layui的element模块事件过滤器
                isRefreshCacheTab: true, //是否刷新页面时缓存tab
        ...
        //设置英文语言
        $(".closeenlanguage").click(function(){
            bodyTab.set({
                openTabNum: "50",  //最大可打开窗口数量
                tabFilter: "bodyTab",  //layui的element模块事件过滤器
                isRefreshCacheTab: true, //是否刷新页面时缓存tab
                ajaxSettings: {  //ajax参数，与jquery.ajax一致
                    url: "services/data/menuEN.json?language=en",
                    type: 'get'
                }
            });
        });
        ...
        $(document).on("click", "#unlock", function () {
            ...
            if ($(thisEle).siblings(".admin-header-lock-input").val() == '') {
                ...
                setTimeout(function () {
                    ...
                    if (user.passwd == getCookie('password')) {
        ...
        $(".closechlanguage").on("click", function () {
           
        });
        $(".closeenlanguage").on("click", function () {
